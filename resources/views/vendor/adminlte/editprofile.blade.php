            ...
            <form action="/admin/settingsprofile" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group " style="border-radius: 30px">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ $user->name }}"
                           placeholder="{{ trans('adminlte::adminlte.full_name') }}" style="border-radius: 15px">
                </div>
                <div class="form-group ">
                    <label>E-Mail</label>
                    <input type="email" name="email" class="form-control" value="{{ $user->email }}"
                           placeholder="{{ trans('adminlte::adminlte.email') }}" style="border-radius: 15px">
                </div>
                <div class="form-group ">
                    <label>Perguruan Tinggi</label>
                    <input type="text" name="perguruan_tinggi" class="form-control" value="{{ $user->perguruan_tinggi }}" 
                           placeholder="Perguruan Tinggi" style="border-radius: 15px">
                </div>
                <div class="form-group ">
                    <label>NIDN</label>
                    <input type="text" name="nidn" class="form-control" value="{{ $user->nidn }}" 
                           placeholder="NIDN" style="border-radius: 15px">
                </div>                     
                <div class="form-group">
                    <label>Foto</label>
                ...
                <button type="submit" class="btn btn-primary btn-block" style="border-radius: 15px">Simpan</button>
            </form>
        </div>
        <div class="col-md-4"></div>
              </div>
